...
Now as we have already seen about different sections present in the daily standup, lets have a look at examples for how to actually write daily standup. We will be discussing about good and bad standup below. Let's assume we are working on project called "Padhandash".
...
### Standup Without Blockers

```
// Standup without blockers

Today (Monday - February 6th)
---
Padhandash:
  - Added functionality to filter courses according to the course rating.
  - Implemented design functionality for instructor's detail page.

Tomorrow
---
Padhandash:
  - Sprint planning and demo meeting for implemented features with the team.
