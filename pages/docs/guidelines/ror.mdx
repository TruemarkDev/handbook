...
RailsAdmin is a rails engine that provides an easy-to-use interface to manage your data. It offers a great set of features, enlisted below, in order to integrate your data aided by the simple interface it avails:
