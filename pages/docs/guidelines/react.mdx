...
Find the npm package, github link and official documentation below:
...
Official Documentation: [bootstrap docs](https://getbootstrap.com/docs/5.2/getting-started/introduction/)
...
Official Documentation: [react-datepicker-demo](https://reactdatepicker.com/)
...
Official Documentation: [react-final-form docs](https://final-form.org/docs/react-final-form/getting-started)
...
Official Documentation: [axios docs](https://axios-http.com/docs/intro)
...
Official Documentation: [react-dnd docs](https://react-dnd.github.io/react-dnd/about)
...
Official Documentation: [SASS docs](https://sass-lang.com/documentation/)
...
Official Documentation [react-fontawesome docs](https://fontawesome.com/v5/docs/web/use-with/react)
...
Official Documentation: [react-select docs](https://react-select.com/home#getting-started)
...
Official Documentation: [eslint docs](https://eslint.org/docs/latest/)
...
Official Documentation: [prettier docs](https://prettier.io/docs/en/options.html)
...
Official Documentation: [stylelint docs](https://stylelint.io/user-guide/get-started/)
...
Official Documentation: [husky docs](https://typicode.github.io/husky/#/)
...
Official Documentation: [react-router-dom docs](https://reactrouter.com/en/main)
...
Official Documentation: [lodash docs](https://lodash.com/docs/)
...
Documentation: [react-trix docs](https://openbase.com/js/react-trix)
...
Official Documentation: [react-dropzone docs](https://react-dropzone.js.org/)
