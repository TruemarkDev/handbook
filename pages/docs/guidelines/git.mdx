...
Now lets see example for each commit type:

1.Features

```
features/770/filter-product-by-category
```

2.Fixes

```
fixes/1237/issue-while-updating-product-info
```

3. Hot Fixes

```
hot-fixes/1189/issue-while-signing-with-invalid-credentials
```

4. Upgrades

```
upgrades/789/upgrade-react-router-dom-to-v6
```
